...
export function WebsiteItem(props: { data: IWebsite }) {
  ...
  return (
    <div className="inline-block w-16 h-16 mx-2">
      <div onClick={() => window.open(data.url)} className="w-16 h-16 rounded-md border border-solid border-red-600 select-none cursor-pointer bg-red-500 bg-opacity-20 flex flex-col justify-center items-center drop-shadow">
        <div>
